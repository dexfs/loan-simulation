...
public class ListSimulationResponse {
    ...
    private ListSimulationResponse(int id, Customer customer, double amount, List<SimulationInstallment> installments, LocalDateTime createdAt) {
        this.id = id;
    ...
    public static ListSimulationResponse create(Simulation simulation) {
        return new ListSimulationResponse(
                simulation.getId(),
